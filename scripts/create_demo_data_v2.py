...
def create_demo_data():
    print("🚀 Начинаем создание демонстрационных данных (v2)...")

    # --- 1. МЕНЕДЖЕР ---
    manager, _ = User.objects.get_or_create(
        username='alina.yazykova',
        defaults={
            'email': 'alina@lingward.online',
            'first_name': 'Алина',
            'last_name': 'Языкова',
            'role': 'admin',
            'is_active': True,
    ...
    manager.save()
    print("✅ Менеджер Алина Языкова создана.")
    ...
    print(f"✅ Репетитор Анна Петрова создан(а).")
    ...
    print(f"✅ Репетитор Иван Смирнов создан(а).")
    ...
    for username, first, last in group_names:
        ...
        print(f"✅ Студент {first} {last} создан(а).")
    ...
    print("🎉 Демонстрационные данные (v2) успешно созданы!")
